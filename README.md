...
then to the dev tools and click on" https://cors-anywhere.herokuapp.com/https://koolgamebackend.herokuapp.com/api/userscore. "
If this link does not redirect you to the page please copy the link and open it in another tab. Lastly please click on the Request Temporary Access to the demo server.
